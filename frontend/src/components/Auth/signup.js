...
<div className="grid md:grid-cols-2">
  {/* LEFT: brand / marketing panel with full image */}
  <div className="relative flex flex-col justify-between overflow-hidden">
    ...
    {/* Soft white overlay like the design */}
    ...
    <div className="relative z-10 px-10 py-10 flex flex-col justify-between h-full">
      ...
      {/* Hero text + stats block (center area) */}
      <div>
        ...
        <div className="bg-white px-10 py-10 flex flex-col justify-center border-l border-slate-200">
          <div className="w-full max-w-md mx-auto">
            ...
            <div className="flex items-center gap-2 mb-7">
              <span className="text-[11px] text-slate-500">I am an</span>
              <div className="flex gap-2 flex-1">
                ...
                <Link
                  to="/signup/operator"
                  className="flex-1 rounded-full bg-slate-100 text-xs font-medium text-slate-700 py-2 text-center hover:bg-slate-200 transition"
                >
              ...
              {currentStep === 2 && (
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <input
                        ...
                        } rounded-md px-3 py-2.5 text-xs text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500`}
               ...
               {/* Address */}
                  <div>
                    ...
                    {/* Optional: keep the 'Use my location' button */}
                    <button
                      type="button"
                  ...
                  {/* Inline map, like operator signup */}
                  <div className="mt-4">
                    <label className="block text-xs font-medium text-slate-700 mb-2">
                    ...
                    <select
                      ...
                      className={`w-full bg-white border ${
                        errors.chargingType
                          ? "border-red-400"
                          : "border-slate-300"
                      } rounded-md px-3 py-2.5 text-xs text-slate-900 focus:outline-none focus:ring-2 focus:ring-emerald-500`}
                    >
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={handleInputChange}
                        className="w-full bg-white border border-slate-300 rounded-md pl-9 pr-3 py-2.5 text-xs text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500"
                        placeholder="75 kWh"
                      />
                    </div>
                  </div>
