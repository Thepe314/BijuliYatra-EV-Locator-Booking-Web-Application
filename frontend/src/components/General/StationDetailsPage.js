// src/pages/admin/StationDetailsPage.jsx
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm overflow-hidden">
              <div className={`h-64 md:h-96 bg-gradient-to-br ${images[activeImage].color} flex items-center justify-center text-white relative`}>
              ...
              <div className="grid grid-cols-4 gap-2 p-4 bg-gray-50">
                {images.map((img, idx) => (
                  <button
                    ...
                    className={`h-16 md:h-20 rounded-lg bg-gradient-to-br ${img.color} transition-all ${
